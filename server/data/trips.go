...
var Trips = []Trip{
	{
		...
		Tags: []string{"เกาะ", "ทะเล", "จุดชมวิว", "ธรรมชาติ", "ตราด"},
	},
	{
		Title:       "ลัดเลาะ 10 ที่เที่ยวย่าน BTS สายสีเขียว",
		EID:         "2",
		URL:         "https://www.wongnai.com/trips/new-bts-route-trips",
		Description: "BTS สายสีเขียวเปิดให้บริการเพิ่ม 5 สถานีทั้งที งานนี้ต้องไม่มีพลาด รีบไปอัปเดต เช็กอินที่เที่ยวคูล ๆ ไปได้ง่ายก่อนใคร เริ่มกันที่ ‘สถานีห้าแยกลาดพร้าว’ เป็นสถานีที่เชื่อมกับเซ็นทรัลลาดพร้าว ซึ่งเป็นห้างที่เรียกได้ว่าครบจบในที่เดียว แต่เราไม่ได้จะพามาเที่ยวห้างหรอกนะ มาถึงนี่ทั้งทีเราจะพาไปทำกิจกรรมสายแอดเวนเจอร์สุดมันส์ และต่อด้วยหาร้านนั่งกินแก้เหนื่อยกันดีกว่า",
		Photos: []string{
		...
		Tags: []string{"คาเฟ่", "ร้านกาแฟ", "จุดถ่ายรูป", "เที่ยวใกล้กรุง", "กรุงเทพมหานคร"},
	},
	{
		...
		Tags: []string{"จุดถ่ายรูป", "ถ่ายรูปสวย", "เที่ยวใกล้กรุง", "ชลบุรี"},
	},
	{
		...
		Tags: []string{"จุดถ่ายรูป", "หมู่บ้าน", "ภูเขา", "ธรรมชาติ", "ถ่ายรูปสวย", "บ้านอีต่องเหมืองปิล็อก", "กาญจนบุรี"},
	},
	{
		...
		Tags: []string{"จุดถ่ายรูป", "ถ่ายรูปสวย", "ร้านกาแฟ", "เชียงใหม่", "คาเฟ่"},
	},
	{
		...
		Tags: []string{"ทะเล", "เกาะ", "สตูล", "ธรรมชาติ"},
	},
	{
		...
		Tags: []string{"จุดถ่ายรูป", "ต่างประเทศ", "ไต้หวัน", "ธรรมชาติ"},
	},
	{
		...
		Tags: []string{"จุดถ่ายรูป", "ต่างประเทศ", "ญี่ปุ่น", "ธรรมชาติ", "ภูเขา"},
	},
	{
		...
		Tags: []string{"จุดถ่ายรูป", "ต่างประเทศ", "ฝรั่งเศส"},
	},
	{
		...
		Tags: []string{"ต่างประเทศ", "ฟินแลนด์", "หิมะ", "ธรรมชาติ"},
	},
}
